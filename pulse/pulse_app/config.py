...
DEFAULT_SEARCH_PROFILES = [
    ...
    },
    {
        ...
        "label": "Major Instagram news",
        "topic": "instagram",
        "queries": ["Instagram major announcement official", "Instagram outage security official"],
        "keywords": ["instagram", "security", "outage", "official", "announcement"],
        "active": True,
    },
    {
        "id": "discord-discovery",
        "label": "Major Discord news",
        "topic": "discord",
        "queries": ["Discord major announcement official", "Discord outage security official"],
        "keywords": ["discord", "security", "outage", "official", "announcement"],
        "active": True,
    },
    {
        "id": "rocket-league-discovery",
        "label": "Major Rocket League news",
        "topic": "rocket_league",
        "queries": ["Rocket League major update official"],
        "keywords": ["rocket league", "update", "season", "announcement", "official"],
        "active": True,
    },
    {
        "id": "unstable-smp-discovery",
        "label": "Unstable SMP and Universe",
        "topic": "unstable_smp",
        "queries": ["Unstable SMP major update", "Unstable Universe announcement"],
